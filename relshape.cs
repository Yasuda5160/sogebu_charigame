...
public class relshape : MonoBehaviour
{
    //MeshFilter
    ...
    public void Awake()
    {
        ...
        cam = Camera.main;
        PlayerView = cam.GetComponent<PlayerView>();
        Objects = centralObject.GetComponent<Objects>();

        //importing the position of central object in world frame from cubeMove's four vector x4
        centralobjectposworldframe4 = Objects.objposworldframe4;
        ...
        Lplayerinverse = PlayerView.Lplayer.inverse;
    ...
    public void LateUpdate()
    {
        ...
        Lplayer = PlayerView.Lplayer;//world frame to player's rest frame
        Lplayerinverse = PlayerView.Lplayer.inverse;
        ...
        for (int i = 0; i < vertices.Length; ++i)
        {
            ...
            //vv4 in world frame
            Vector4 vv4 = vv;
            vv4.w = PlayerView.playrposworldframe4.w - (PlayerView.playrposworldframe3 - vv).magnitude;
            //position of vertices in World Frame4
            /*if (!this.originalVertices.Contains(vertex))
            {*/
            //
            vertexposplayrrestframe4 = Lplayer * vv4 - PlayerView.Lplayer * Objects.objposworldframe4;

...
public class PlayerView : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        if (playrposworldframe3.y <= Stairpositionworldframe3.y + 3.5f)
        {
            //when player collided with a stair
            touch = true;
        }
        ...
        {
            playrposworldframe3.y = playrposworldframe3.y;
            touch = false;
        }
        //defining Electromagnetic tensor at player's position
        //Ftensor = ArrowDirection2.G;
        ...
        {
            playraccelworldframe3 += Vector3.up * (unitAccel - gravity);
        }
        else
        {
            playraccelworldframe3 += Vector3.up * (- gravity);
        }
        ...
        /*if(playrposworldframe4.y =< StairInstantiate.instanty)
        {
            playrposworldframe4.y = StairInstantiate.instanty;
        }
        else
        {
            playrposworldframe4.y = playrposworldframe4.y;
        }*/
        playrposworldframe3 = playrposworldframe4;
        //Caluculate the index of the nearest floor in the world frame
        float section = (playrposworldframe3.z + 20.0f) / 20.0f;
        Stairpositionworldframe3 = StairInstantiate.instant2[Mathf.FloorToInt(section)];
        Stairpositionworldframe4 = Stairpositionworldframe3;
        Stairpositionworldframe4.w = (Stairpositionworldframe3 - playrposworldframe3).magnitude;
        Debug.Log($"instanty={Stairpositionworldframe3.y}");
        Debug.Log($"playrposworldframe3.y={playrposworldframe3.y}");
        this.transform.position = Lplayer * playrposworldframe4;
    }
